        ...
        <KeyboardAvoidingView style={tw`flex-1`}>
          ...
          <View style={tw`w-full`}>
            ...
            <View style={tw`ml-5 top-20`}>
              <Text style={tw`text-black text-xl font-bold tracking-widest`}>Selamat Datang Kembali,</Text>
              <Text style={tw`text-black text-md font-light tracking-widest pt-1`}>Masukan akun untuk bergabung</Text>
            </View>
          </View>
          <View style={tw`top-1/4`}>
            <View style={tw`mx-5`}>
              <Text style={tw`font-semibold text-md`}>Username</Text>
              <TextInput
                style={tw`border-2 border-gray-200 rounded-md p-2 text-md`}
                placeholder='Masukan Username'
                placeholderTextColor='#A9A9A9'
              />
              <Text style={tw`font-semibold text-md mt-5`}>Password</Text>
              <TextInput
                style={tw`border-2 border-gray-200 rounded-md p-2 text-md`}
